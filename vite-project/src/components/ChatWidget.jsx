...
const ChatWidget = () => {
    ...
    const initialMessage = {
        text: "Hello! Welcome to <strong>Tech Roxx</strong> 🚀 I am your professional NLP assistant.<br/>" +
              "I can help you explore courses, navigate pages, join our active WhatsApp community, or contact our team.<br/><br/>" +
    ...
    const getIntent = (cleanedText) => {
        const intents = {
            ...
            about: ["who", "what is", "about", "founder", "leaders", "hemanth", "keerthi", "shiva", "company", "institute", "organization", "academy", "tech roxx", "techroxx"],
        ...
        setTimeout(() => {
            ...
            // 4. Intent matching fallback
                ...
                switch (intent) {
                    ...
                    case 'about':
                        replyHTML = `<strong>Tech Roxx</strong> is a premier tech institute based in Hyderabad, designed to bridge the gap between academia and corporate environments.<br/><br/>` +
                    ...
                    case 'placement':
                        replyHTML = `<strong>Placement Program & Support:</strong><br/>` +
                                    ...
                                    `Redirecting to the <strong>Placement Guide</strong> details...` +
                                    `<div class='chat-quick-replies'>` +
