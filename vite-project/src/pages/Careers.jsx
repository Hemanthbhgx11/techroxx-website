...
import { loadJobsData } from '../utils/dataLoader';
                    ...
                    <div className="modal-content-wrapper glass-panel" onClick={(e) => e.stopPropagation()} style={{ maxWidth: showApplyForm ? '600px' : '820px', border: '1px solid rgba(239, 68, 68, 0.2)' }}>
                        ...
                        <div className="modal-header">
                            <div>
                                ...
                                <h3 style={{ color: 'var(--secondary-blue)', fontSize: '0.9rem', fontWeight: 700, margin: 0, textTransform: 'uppercase', letterSpacing: '0.5px' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                                <div style={{ fontSize: '0.88rem', color: 'var(--text-main)', display: 'flex', alignItems: 'center', gap: '10px' }}>
                                    <i className="fas fa-laptop-code" style={{ color: 'var(--primary-brand)', width: '16px' }}></i>
                                    <span><strong>Active Internships:</strong> 11 Specialized Tracks</span>
                                </div>
                                <div style={{ fontSize: '0.88rem', color: 'var(--text-main)', display: 'flex', alignItems: 'center', gap: '10px' }}>
                                    <i className="fas fa-graduation-cap" style={{ color: 'var(--primary-brand)', width: '16px' }}></i>
