...
.highlight-card:hover { transform: translateY(-10px) scale(1.02); background: var(--bg-panel); box-shadow: 0 20px 40px -5px rgba(0,0,0,0.1); border-color: var(--secondary-blue); }
...
.leader-card { background: var(--bg-panel); width: 300px; border-radius: 15px; padding: 30px; text-align: center; border: 1px solid #e2e8f0; position: relative; box-shadow: var(--card-shadow); transition: 0.3s; }
...
.consultancy-card { background: var(--bg-panel); border: 1px solid #e2e8f0; border-radius: 12px; padding: 30px; text-align: center; transition: 0.3s; position: relative; overflow: hidden; cursor: pointer; box-shadow: var(--card-shadow); }
...
.social-btn { display: flex; align-items: center; gap: 8px; padding: 8px 16px; background: var(--bg-panel); border-radius: 6px; min-width: 160px; transition: 0.3s; border: 1px solid #e2e8f0; color: var(--text-main); box-shadow: 0 2px 5px rgba(0,0,0,0.05); font-size: 0.85rem; cursor: pointer; }
...
.back-btn { background: var(--bg-panel); color: var(--text-muted); border: 1px solid #cbd5e1; padding: 5px 12px; border-radius: 5px; cursor: pointer; font-family: var(--font-body); font-size: 0.8rem; transition: 0.3s; display: flex; align-items: center; gap: 8px; }
...
.detail-item { background: var(--bg-panel); border: 1px solid #e2e8f0; padding: 25px; border-radius: 10px; display: flex; justify-content: space-between; align-items: center; transition: 0.3s; box-shadow: 0 2px 5px rgba(0,0,0,0.03); }
...
.chat-window { position: absolute; bottom: 80px; right: 0; width: 350px; height: 450px; background: var(--bg-panel); backdrop-filter: blur(10px); border: 1px solid #e2e8f0; border-radius: 15px; display: flex; flex-direction: column; overflow: hidden; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.15); animation: fadeInUp 0.3s ease-out; }
...
.msg-bot { align-self: flex-start; background: var(--bg-panel); border: 1px solid #e2e8f0; border-left: 3px solid var(--secondary-blue); color: var(--text-main); }
.msg-user { align-self: flex-end; background: var(--secondary-blue); color: white; border-bottom-right-radius: 2px; }
.chat-input-area { padding: 15px; border-top: 1px solid #e2e8f0; display: flex; gap: 10px; background: var(--bg-panel); }
...
.chat-input:focus { border-color: var(--secondary-blue); background: var(--bg-panel); }
        ...
        if (subView) {
            ...
            switch(view) {
                ...
                case 'partners':
                    ...
                    desc = "Tech Roxx partners with friendly organizations to provide real-time projects and student internships.";
                    break;
                case 'contact':
        ...
        <div className="app-container">
            ...
            <main style={{ marginTop: '100px', minHeight: 'calc(100vh - 80px - 200px)' }}>
                ...
                {view === 'partners' && !subView && (
                    <section className="section-padding about animate-enter" style={{ background: 'var(--bg-dark)' }}>
                        <div className="container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', marginTop: '40px' }}>
                                <div className="glass-panel" style={{
                                    ...
                                    <h3 style={{ fontSize: '1.4rem', fontWeight: 800, color: 'var(--text-main)', margin: 0 }}>Become a Partner</h3>
                                    <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', lineHeight: 1.6, margin: 0 }}>
                                        Join our premier network of industry leaders, corporate networks, and academic ecosystems. Let's build structured milestones and empower engineering students together.
                                    </p>
                                    <button 
                                        onClick={() => handleNav('contact')} 
                                        className="btn btn-primary" 
                                        style={{ padding: '10px 25px', marginTop: '10px', fontSize: '0.85rem' }}
                                    >
                                        Collaborate With Us
                                    </button>
                                </div>
                            </div>
                            <p style={{ textAlign: 'center', color: 'var(--text-muted)', marginTop: '40px', maxWidth: '600px', fontSize: '0.9rem' }}>
                                We are proud to collaborate with organisations that share our vision of bridging academics and industry.
                            </p>
                        </div>
                    </section>
                )}
                ...
                {subView === 'dept-details' && selectedData && (
                    <section className="section-padding animate-enter" style={{ 
                        ...
                        <div className="container">
                            ...
                            <p className="dept-detail-subtitle" style={{ textAlign: 'center', color: 'var(--secondary-blue)', marginBottom: '40px', fontSize: '1.2rem', fontWeight: 600 }}>{selectedData.title} - {selectedData.subtitle}</p>
