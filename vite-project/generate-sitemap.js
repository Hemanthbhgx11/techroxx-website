...
const generateSitemap = async () => {
    const urls = [
        ...
        { loc: '/learn/iot-telemetry-esp32-guide', changefreq: 'weekly', priority: '0.8' },
        { loc: '/learn/pcb-layout-design-guide', changefreq: 'weekly', priority: '0.8' },
        { loc: '/learn/agentic-ai-multi-agent-workflows', changefreq: 'weekly', priority: '0.8' },
        { loc: '/learn/mern-fullstack-career-strategies', changefreq: 'weekly', priority: '0.8' },
